...
<div class="row text-center pt-3">
    <div class="col">
        ...
        <h1 class="text-danger fw-bold mb-4"><?= $_SESSION['username'] ?></h1>
    </div>
</div>
...
<div class="row text-center mb-5">
    <div class="col">
        ...
        if ($foto_profil != '' && file_exists("img/" . $foto_profil)) {
            ...
            echo '<img src="https://ui-avatars.com/api/?name='.$_SESSION['username'].'&background=random&size=200" class="rounded-circle shadow" style="width: 200px; height: 200px; object-fit: cover;">';
        }
        ?>
    </div>
</div>
...
<div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center mb-5">
    <div class="col">
        <div class="card border-danger mb-3 shadow" style="max-width: 18rem;">
            <div class="card-body">
