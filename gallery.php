<?php
// Cek apakah user sudah login (safety check)
...
if (isset($_POST['simpan'])) {
    ...
    $user_id = $_SESSION['id']; // Pastikan session id sudah ada saat login
...
$(document).ready(function(){
    ...
    $(document).on('click', '.btn-edit', function(){
        ...
        // Gambar tidak bisa di-set valuenya karena security browser, biarkan kosong
