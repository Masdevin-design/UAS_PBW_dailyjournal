...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    $active = "active"; // Penanda untuk item pertama
                    ...
                    <?php
                            $active = ""; // Hapus active agar item selanjutnya tidak numpuk
                        }
                    } else {
                        // Gambar default jika tidak ada data
    ...
    <footer class="text-center p-5">
      ...
      <div>Devin Abiyyu Pandu Pratama &copy; 2025</div>
    </footer>
    <script
